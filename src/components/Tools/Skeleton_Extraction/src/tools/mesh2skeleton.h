#ifndef MESHTOSKELETON_H
#define MESHTOSKELETON_H
...
public:
    ...
    MeshToSkeleton(MeshT mesh)
    {
        ...
        {
            typename MeshT::Point point = mesh.point(v_it);
            add_vertex(Vec3d(point));
        }
